...
export default class MMDHelper
{
    ...
    setPhysics(mesh: THREE.SkinnedMesh, params: {world?: any, warmup?: number, preventAnimationWarmup?: boolean} = {})
    {
    ...
    animateOneMesh(delta, mesh: THREE.SkinnedMesh)
    {
        var mixer = mesh.mixer;
